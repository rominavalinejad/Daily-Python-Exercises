...
3. Print the calculated distance.
4. Add a conditional check to verify if the point is "far" (distance > 4) or "close" (distance <= 4) to the origin and print the corresponding message.
